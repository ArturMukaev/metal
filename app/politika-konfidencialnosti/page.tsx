...
export const metadata: Metadata = {
  title: "Политика конфиденциальности | СТИЛКРАФТ",
  description: "Политика обработки персональных данных компании СТИЛКРАФТ",
};

export default function PrivacyPolicyPage() {
  const websiteUrl = companyInfo.url;
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 space-y-8">
            <section>
              ...
              <p className="text-gray-700 mb-4">
                ...
                персональных данных, предпринимаемые {companyInfo.name} (далее –
                Оператор).
              </p>
              <p className="text-gray-700 mb-4">
            ...
            <section>
              ...
              <div className="space-y-3">
                ...
                <p className="text-gray-700">
                  ...
                  определяемому Пользователю веб-сайта {websiteUrl};
                </p>
                <p className="text-gray-700">
                  <strong>2.9. Пользователь</strong> – любой посетитель
                  веб-сайта {websiteUrl};
                </p>
                <p className="text-gray-700">
                ...
                <p className="text-gray-700">
                  <strong>2.11. Распространение персональных данных</strong> –
            ...
            <section>
              ...
              <div className="space-y-3">
                <p className="text-gray-700">3.1. Фамилия, имя, отчество;</p>
                <p className="text-gray-700">3.2. Электронный адрес;</p>
                <p className="text-gray-700">3.3. Номера телефонов;</p>
                <p className="text-gray-700">3.4. Фотографии;</p>
                <p className="text-gray-700">
            ...
            <section>
              ...
              <p className="text-gray-700 mb-4">
                ...
                {websiteUrl}. Заполняя соответствующие формы и/или отправляя
            ...
            <section>
              ...
              <p className="text-gray-700">
                ...
                в сети Интернет по адресу {websiteUrl}
