        ...
        <div className="container-custom">
          ...
          <div className="max-w-4xl">
            <p className="text-lg text-gray-700 mb-4">
              Компания «СТИЛ КРАФТ» изготовит на заказ по чертежам заказчика металлические
              конструкции и изделия, нестандартное оборудование для разных сфер промышленности. На
              официальном сайте можно ознакомиться с примерами выполненных работ. Предлагаем
              вниманию клиентов фотографии, отображающие технологические процессы на предприятии и
              демонстрирующие готовые изделия.
            </p>
            <p className="text-lg text-gray-700">
              За время работы ООО «СТИЛ КРАФТ» получило огромное количество заказов. Мы постоянно
              расширяем клиентскую базу, улучшая оснащение предприятия, расширяя перечень
              предоставляемых услуг и оптимизируя цены на механообработку металла. Работаем с
              конструкционными и нержавеющими сталями, цветным металлом. Нам доверяют, поскольку на
      ...
      <section className="section-padding bg-white">
        <div className="container-custom max-w-4xl">
          ...
          <p className="text-gray-700">
            ...
            <a href="tel:+79027981670" className="text-primary hover:text-primary-dark font-semibold">
              +7 (902) 798-16-70
            </a>
            .
          </p>
