          ...
          <div className="max-w-4xl mx-auto text-center">
            <p className="text-lg md:text-xl text-gray-700 leading-relaxed">
              <strong>
                ...
                химической, газовой, строительства и др. Мы изготовим детали,
                узлы и агрегаты к машинам и механизмам таким как транспортные
                средства, промышленное оборудование, прессформы и иные
                технические изделия. Наша компания также предоставляет услуги
                полного цикла изготовления таких изделий, как: звездочки,
                зубчатые рейки, шестерни с различными видами зацепления (косой,
                прямой, эвольвентный, шевронный, червячный).
              </strong>
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="order-2 lg:order-1 hidden lg:block">
              <div className="relative aspect-[4/3] rounded-lg overflow-hidden shadow-xl">
                <Image
                  src="/images/services/frezerovanie.jpg"
